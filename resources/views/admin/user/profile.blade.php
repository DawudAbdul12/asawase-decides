            ...
            <div class="row items-push">
                ...
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Settings</li>
                        <li><a class="link-effect" href="/admin/settings/change-password">change Password</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-narrow">
                            ...
                            <form class="js-validation-material form-horizontal push-10-t" action="/admin/settings/profile" method="post" enctype="multipart/form-data">
                                @csrf
