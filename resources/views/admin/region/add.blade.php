                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-3 col-lg-8 col-lg-offset-2">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-narrow">
                            ...
                            <form class="js-validation-material form-horizontal push-10-t" action="/admin/region" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="col-sm-12">
                                    <div class="form-material">
                                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="val-name" name="name" placeholder="Enter region name"value="{{ old('name') }}" required autocomplete="name">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="form-material">
                                            <textarea class="form-control" id=""  name="description" rows="3" placeholder="Enter a description "></textarea>
