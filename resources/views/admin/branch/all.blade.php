            ...
            <div class="row items-push">
                ...
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Branch</li>
                        <li><a class="link-effect" href="/admin/branch/create">Add a Branch</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="block">
                ...
                <div class="block-content">
                            ...
                            <tbody>
                                ...
                                @forelse ($branches as $branch)
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/admin/branch/{{ $branch->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                <form method="POST" action="/admin/branch/{{ $branch->id }}" accept-charset="UTF-8">
                    ...
                    {{ $branches->links('admin.components.pagination') }}
                </div>
            </div>
            <!-- END Full Table -->
        </div>
